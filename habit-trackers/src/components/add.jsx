...
const Add = memo( (props) => {  // class에 purecomponent가 있다면 함수에는 memo가 있다 purecomponent처럼 props가 변경되지 않으면 함수가 호출x
  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} className='addForm'>
      <input ref={addFormInput} className='addForm__input' placeholder='Habit' type="text" />
